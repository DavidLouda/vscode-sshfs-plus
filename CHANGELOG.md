...
## Previous releases (SSH FS by Kelvin Schoofs)

The changelog entries below are from the original [SSH FS](https://github.com/SchoofsKelvin/vscode-sshfs) project.
